...
if (o == null) o = "../java/";
J.viewer.Viewer.appletCodeBase = o.toString ();
J.viewer.Viewer.appletIdiomaBase = J.viewer.Viewer.appletCodeBase.substring (0, J.viewer.Viewer.appletCodeBase.lastIndexOf ("/", J.viewer.Viewer.appletCodeBase.length - 2) + 1) + "idioma";
o = info.get ("documentBase");
J.viewer.Viewer.appletDocumentBase = (o == null ? "" : o.toString ());
o = info.get ("options");
...
this.strJavaVendor = J.viewer.Viewer.strJavaVendor = "Java2Script " + (this.isWebGL ? "(WebGL)" : "(HTML5)");
}
...
if (o == null && !this.isWebGL) o = J.api.Interface.getOptionInterface ("g3d.Graphics3D");
...
this.tm =  new J.viewer.TransformManager (this, 2147483647, 0);
...
this.cd (path);
}path = J.viewer.Viewer.appletDocumentBase;
i = path.indexOf ("#");
...
this.fileManager.setAppletContext (J.viewer.Viewer.appletDocumentBase);
...
this.logFilePath = JU.PT.rep (J.viewer.Viewer.appletCodeBase, "file://", "");
...
$_M(c$, "getMinimizer", 
function (createNew) {
return (this.minimizer == null && createNew ? (this.minimizer = J.api.Interface.getOptionInterface ("minimize.Minimizer")).setProperty ("viewer", this) : this.minimizer);
}, "~B");
...
}this.statusManager.setStatusFrameChanged (fileNo, modelNo, (this.animationManager.animationDirection < 0 ? -firstNo : firstNo), (this.animationManager.currentDirection < 0 ? -lastNo : lastNo), currentFrame, entryName);
...
($fz = function () {
if (this.jsv == null) {
this.jsv = J.api.Interface.getOptionInterface ("jsv.JSpecView");
...
this.global.setS ("defaultLattice", J.util.Escape.eP (p));
}, "JU.P3");
...
}}var bioComment = (bioAddComment ? J.viewer.Viewer.getJmolVersion () + " " + this.getModelName (this.getCurrentModelIndex ()) : null);
...
}var export3D = J.api.Interface.getOptionInterface ("export.Export3D");
...
{
{
self.Jmol && Jmol.extend && Jmol.extend("viewer", J.viewer.Viewer.prototype);
