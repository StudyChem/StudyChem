...
Clazz.load (["J.export.__CartesianExporter", "java.util.Hashtable", "JU.P3"], "J.export._VrmlExporter", ["java.lang.Boolean", "$.Float", "$.Short", "JU.List", "$.PT", "J.export.UseTable", "J.util.Quaternion", "J.viewer.Viewer"], function () {
...
$_V(c$, "outputHeader", 
function () {
this.output ("#VRML V2.0 utf8 Generated by Jmol " + J.viewer.Viewer.getJmolVersion () + "\n");
this.output ("WorldInfo { \n");
this.output (" title " + JU.PT.esc (this.viewer.getModelSetName ()) + "\n");
this.output (" info [ \"Generated by Jmol " + J.viewer.Viewer.getJmolVersion () + " \", \n");
...
var a = J.util.Quaternion.getQuaternionFrame (ptCenter, this.tempQ1, this.tempQ2).toAxisAngle4f ();
if (!Float.isNaN (a.x)) {
