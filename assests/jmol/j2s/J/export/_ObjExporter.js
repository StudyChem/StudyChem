...
Clazz.load (["J.export.__CartesianExporter", "java.util.HashSet", "JU.P3"], "J.export._ObjExporter", ["java.lang.Short", "java.util.Hashtable", "JU.AU", "$.BS", "$.CU", "$.List", "$.M4", "$.PT", "$.SB", "$.V3", "J.export.MeshData", "J.modelset.Atom", "J.util.C", "$.Escape", "$.Logger", "$.MeshSurface", "$.Quaternion", "J.viewer.Viewer"], function () {
...
this.debugPrint ("  Not done owing to surfacesOnly");
return;
}var a = J.util.Quaternion.getQuaternionFrame (center, points[1], points[3]).toAxisAngle4f ();
...
this.debugPrint ("  Not done owing to surfacesOnly");
return;
}var colix = J.util.C.getColix (argb);
...
var data = J.util.MeshSurface.newMesh (false, meshSurface.vertices, meshSurface.vertexCount, faces, meshSurface.normals, 0);
...
this.outputMtl ("# Created by Jmol " + J.viewer.Viewer.getJmolVersion () + "\n");
...
$_M(c$, "getTextureName", 
($fz = function (colix) {
return "k" + J.util.Escape.getHexColorFromRGB (this.g3d.getColorArgbOrGray (colix));
...
var data = J.util.MeshSurface.getSphereData (3);
this.addTexture (colix, null);
var name;
if (Clazz.instanceOf (center, J.modelset.Atom)) {
var atom = center;
...
}, $fz.isPrivate = true, $fz), "~S,J.util.MeshSurface,JU.M4,JU.M4,~N,~A,JU.BS");
$_M(c$, "outputList", 
...
}, $fz.isPrivate = true, $fz), "~S,J.util.MeshSurface,~A");
