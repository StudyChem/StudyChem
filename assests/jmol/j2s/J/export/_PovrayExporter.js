...
Clazz.load (["J.export.__RayTracerExporter"], "J.export._PovrayExporter", ["java.lang.Float", "$.Short", "JU.P4", "J.util.Measure", "J.viewer.Viewer"], function () {
...
J.util.Measure.getPlaneThroughPoints (screenBase, screenTip, this.tempP1, this.tempV1, this.tempV2, this.tempV3, plane);
